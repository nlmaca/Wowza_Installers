...
# Wowza Fresh installer 4.8.12+1 for Ubuntu 20.04 LTS
# Including: 
# Wowza 4.8.12+1 Installation
...
echo "Install Java 11 + Wowza Streaming Engine 4.8.12+1 including CSF Firewall"
#update 
clear
...
sleep 2
cd /tmp
wget https://vanmarion.nl/projects/wowza/WowzaStreamingEngine-4.8.12+1-linux-x64-installer.run
chmod +x WowzaStreamingEngine-4.8.12+1-linux-x64-installer.run
...
sleep 5
./WowzaStreamingEngine-4.8.12+1-linux-x64-installer.run
