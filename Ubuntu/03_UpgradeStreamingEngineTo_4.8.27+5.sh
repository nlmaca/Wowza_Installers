...
cd /tmp
sudo wget https://vanmarion.nl/projects/wowza/WowzaStreamingEngine-Update-4.8.27+5.zip

echo "unzip the file to the wowza update folder"
sudo unzip WowzaStreamingEngine-Update-4.8.27+5.zip -d /usr/local/WowzaStreamingEngine/updates/WowzaStreamingEngine-Update-4.8.27+5

echo "navigate to the linux update folder"
cd /usr/local/WowzaStreamingEngine/updates/WowzaStreamingEngine-Update-4.8.27+5/linux
...
# This will update your installation to : Wowza Streaming Engine 4.8.27+5 Build 20231212155517
...
sleep 2
echo "Login to your wowza backend. Navigate to Server > About and check if your Wowza version is upgraded to 4.8.27+5"