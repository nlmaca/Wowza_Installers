...
# Wowza installer 4.8.8.01 for Ubuntu 20.04 LTS
# Including: 
#   Wowza 4.8.8.01 Installation
...
# IMPORTANT: after this installer run the update to 4.8.9 (4.8.9 is not available as installer)
...
echo "Install Java 11 + Wowza Streaming Engine 4.8.8.01 + CSF Firewall"
#update 
clear
...
sleep 5
./WowzaStreamingEngine-4.8.8.01-linux-x64-installer.run
