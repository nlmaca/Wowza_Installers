...
cd /tmp
sudo wget https://vanmarion.nl/projects/wowza/WowzaStreamingEngine-Update-4.8.12+1.zip

echo "unzip the file to the wowza update folder"
sudo unzip WowzaStreamingEngine-Update-4.8.12+1.zip -d /usr/local/WowzaStreamingEngine/updates/WowzaStreamingEngine-Update-4.8.12+1

echo "navigate to the linux update folder"
cd /usr/local/WowzaStreamingEngine/updates/WowzaStreamingEngine-Update-4.8.12+1/linux
...
# Currently installed version           : Wowza Streaming Engine xxx
# This will update your installation to : Wowza Streaming Engine xxx
