...
# Make sure to run the patch after this installer!
# check the Patches directory on https://github.com/nlmaca/Wowza_Installers/tree/master/Ubuntu/Patches for the latest versions
# Patch included: Log4j incl 2.17.1
# CVE-2021-44228
# CVE-2021-45046
# CVE-2021-45105
# CVE-2021-44832
...
# switch to that user.
# $: su - USERNAME
# run the wowza installer as sudo bash 20_04_installer_noSSL.sh
...
echo "Install Java 11 + Wowza Streaming Engine 4.8.17+1 including CSF Firewall"
#update 
clear
...
sleep 2
cd /tmp
wget https://www.wowza.com/downloads/WowzaStreamingEngine-4-8-17+1/WowzaStreamingEngine-4.8.17+1-linux-x64-installer.run
...
sleep 5
./WowzaStreamingEngine-4.8.17+1-linux-x64-installer.run
...
# --------------------------------- LOG4j PATCH -----------------------------------------------
sleep 2
echo "make sure to run the LOG4J patch!!."
echo "check the Patches directory on https://github.com/nlmaca/Wowza_Installers/tree/master/Ubuntu/Patches for the latest versions"
sleep 3
