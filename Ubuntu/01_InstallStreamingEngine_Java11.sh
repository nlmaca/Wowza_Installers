...
# Software installation including: 
  ...
  # Java 11.0.19 OpenJDK Installation
  # No SSL
...
echo "Install Java 11 + Wowza Streaming Engine 4.8.23+2 including CSF Firewall"
#update 
clear
...
echo "In wowza EngineManager check Server > About and check if the Java version is version 11.0.19."